...
Example:
    ...
    SYNCMATRIX_API_URL="http://localhost:4200" ./scripts/run-integration-flows.py
"""
import os
import runpy
import sys
...
# See https://github.com/KhulnaSoft/syncmatrix/pull/9136
DEFAULT_PATH = (
    getattr(
        syncmatrix, "__development_base_path__", getattr(syncmatrix, "__root_path__", None)
    )
    / "flows"
)
