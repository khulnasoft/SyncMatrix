...
from syncmatrix.exceptions import FailedRun
from syncmatrix.flows import flow
from syncmatrix.futures import SyncmatrixFuture, resolve_futures_to_data
...
mock_client = MagicMock(spec=SyncmatrixClient)()
...
def test_raise_warning_futures_in_condition():
    ...
    match = "A 'SyncmatrixFuture' from a task call was cast to a boolean"
