...
import syncmatrix
from syncmatrix import __development_base_path__
from syncmatrix.exceptions import ScriptError
from syncmatrix.utilities.dockerutils import docker_client
from syncmatrix.utilities.filesystem import tmpchdir
from syncmatrix.utilities.importtools import (
    from_qualified_name,
    import_object,
    lazy_import,
    to_qualified_name,
...
@pytest.mark.parametrize(
    "obj,expected",
    [
        (to_qualified_name, "syncmatrix.utilities.importtools.to_qualified_name"),
        (syncmatrix.tasks.Task, "syncmatrix.tasks.Task"),
        (syncmatrix.tasks.Task.__call__, "syncmatrix.tasks.Task.__call__"),
...
@pytest.mark.parametrize("obj", [to_qualified_name, syncmatrix.tasks.Task, my_fn, Foo])
