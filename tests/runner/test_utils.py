...
from syncmatrix._vendor.fastapi.routing import APIRoute

from syncmatrix import __version__ as SYNCMATRIX_VERSION
...
def openapi_schema():
    return {
        "openapi": "3.1.0",
        "info": {"title": "FastAPI Syncmatrix Runner", "version": SYNCMATRIX_VERSION},
        "components": {"schemas": {}},
        "paths": {},
    }
