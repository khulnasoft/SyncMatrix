...
from syncmatrix.artifacts import (
...
from syncmatrix.server.schemas.actions import ArtifactCreate
...
class TestCreateArtifacts:
    ...
    async def test_create_link_artifact_using_map_succeeds(self):
        ...
        # An ode to syncmatrix issue #5309.
        @task
        def add_ten(x):
            create_link_artifact(
