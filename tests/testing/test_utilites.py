...
from syncmatrix.testing.utilities import assert_does_not_warn, syncmatrix_test_harness
...
async def test_syncmatrix_test_harness():
    ...
    existing_db_url = SYNCMATRIX_API_DATABASE_CONNECTION_URL.value()
    ...
    with syncmatrix_test_harness():
        async with get_client() as client:
            ...
            assert SYNCMATRIX_API_DATABASE_CONNECTION_URL.value() != existing_db_url
