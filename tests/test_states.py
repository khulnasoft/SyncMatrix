...
from syncmatrix.exceptions import CancelledRun, CrashedRun, FailedRun
...
class TestReturnValueToState:
    @pytest.fixture
    async def factory(self, syncmatrix_client):
        return await ResultFactory.default_factory(client=syncmatrix_client)
    ...
    async def test_returns_single_state_with_data_to_persist(self, syncmatrix_client):
    ...
    async def test_non_syncmatrix_types_return_completed_state(self, factory):
