...
from syncmatrix.server.schemas.core import Log
from syncmatrix.server.schemas.filters import LogFilter
...
class TestCreateLogs:
    ...
    async def test_database_failure(
        ...
        with mock.patch("syncmatrix.server.models.logs.create_logs") as mock_create_logs:
