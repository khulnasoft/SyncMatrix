...
from syncmatrix.server.services.flow_run_notifications import FlowRunNotifications
...
@pytest.mark.parametrize(
    ...
    [
        (None, "http://ephemeral-syncmatrix/api"),
...
def test_get_ui_url_for_flow_run_id_with_ui_url(
    ...
    with temporary_settings({SYNCMATRIX_UI_URL: provided_ui_url}):
