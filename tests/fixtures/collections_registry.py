...
from syncmatrix.server.api import collections
            ...
            "properties": {
                ...
                "image": {
                    ...
                    "description": (
                        ...
                        " jobs. If not set, the latest Syncmatrix image will be used."
                    ),
    ...
    return {
        ...
        "variables": {
            "description": (
                ...
                " use for created jobs.\n        If not set, the latest Syncmatrix image"
...
def mock_collection_registry(
    ...
    mock_body = {
        "syncmatrix": {
            "syncmatrix-agent": {
                ...
                "display_name": "Syncmatrix Agent",
                "description": "A Syncmatrix Agent pool.",
            }
        },
        "syncmatrix-fake": {
            "fake": {
                ...
                "display_name": "Syncmatrix Fake",
                "description": "A Syncmatrix Fake pool.",
            }
        },
        "syncmatrix-cloud": {
            "syncmatrix-cloud:push": {
                "type": "cloud-run:push",
                "default_base_job_configuration": {},
                "is_push_pool": True,
                "display_name": "Syncmatrix Cloud Run: Push",
                "description": "A Syncmatrix Cloud Run: Push pool.",
            }
        },
        "syncmatrix-docker": {
            "docker": {
    ...
    with respx.mock(
        ...
        respx_mock.get(
            "https://raw.githubusercontent.com/KhulnaSoft/syncmatrix-collection-registry/main/views/aggregate-worker-metadata.json"
