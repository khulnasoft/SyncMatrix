...
from syncmatrix.settings import SYNCMATRIX_CLOUD_API_URL


@pytest.fixture
async def syncmatrix_client(test_database_connection_url):
    async with get_client() as client:
        yield client


@pytest.fixture
async def cloud_client(syncmatrix_client):
    async with SyncmatrixClient(SYNCMATRIX_CLOUD_API_URL.value()) as cloud_client:
        yield cloud_client
