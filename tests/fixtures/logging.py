...
from syncmatrix.settings import SYNCMATRIX_LOGGING_TO_API_ENABLED, temporary_settings
...
def enable_api_log_handler_if_marked(request):
    ...
    if marker is not None:
        with temporary_settings(updates={SYNCMATRIX_LOGGING_TO_API_ENABLED: True}):
            yield True
    else:
        yield False
