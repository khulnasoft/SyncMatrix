...
from syncmatrix.cli.root import app as APP
from syncmatrix.cli.root import is_interactive
from syncmatrix.settings import (
    SYNCMATRIX_CLI_PROMPT,
    temporary_settings,
)
...
def test_prompt_force_true_with_setting(test_app):
    with temporary_settings({SYNCMATRIX_CLI_PROMPT: True}):
        assert_interactive(test_app)


def test_prompt_force_false_with_setting(test_app):
    with temporary_settings({SYNCMATRIX_CLI_PROMPT: False}):
        assert_not_interactive(test_app)
