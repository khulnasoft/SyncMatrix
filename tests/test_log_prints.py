...
from syncmatrix.logging.loggers import print_as_log
from syncmatrix.settings import SYNCMATRIX_LOGGING_LOG_PRINTS, temporary_settings
...
def test_root_flow_log_prints_defaults_to_setting_value(caplog, setting_value):
    ...
    with temporary_settings({SYNCMATRIX_LOGGING_LOG_PRINTS: setting_value}):
        test_flow()
