...
from syncmatrix.settings import SYNCMATRIX_API_URL, SYNCMATRIX_UNIT_TEST_MODE, temporary_settings
...
async def test_get_cloud_work_pool_types(mock_work_pool_types):
    ...
    with temporary_settings(
        updates={
            SYNCMATRIX_API_URL: f"https://api.syncmatrix.cloud/api/accounts/{account_id}/workspaces/{workspace_id}/"
        }
    ):
        async with get_cloud_client() as client:
