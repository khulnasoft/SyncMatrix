...
from syncmatrix.client.schemas.filters import ArtifactFilter, ArtifactFilterKey
from syncmatrix.client.schemas.sorting import ArtifactCollectionSort, ArtifactSort
from syncmatrix.exceptions import ObjectNotFound

artifact_app = SyncmatrixTyper(
...
async def list_artifacts(
    ...
    table = Table(
        title="Artifacts",
        caption="List Artifacts using `syncmatrix artifact ls`",
        show_header=True,
    )
...
async def inspect(
    ...
    """
        ...
        Examples:
            $ syncmatrix artifact inspect "my-artifact"
           [
            {
...
async def delete(
    ...
    Examples:
        $ syncmatrix artifact delete "my-artifact"
    """
