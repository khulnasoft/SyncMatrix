...
from syncmatrix.cli._prompts import prompt
...
class IamPolicyResource:
    ...
    Args:
        policy_name: The name of the IAM policy. Defaults to "syncmatrix-ecs-policy".
    """
...
class CredentialsBlockResource:
    ...
    async def requires_provisioning(
        self, client: Optional[SyncmatrixClient] = None
    ) -> bool:
        if self._requires_provisioning is None:
            try:
    ...
    async def provision(
        ...
        Args:
            ...
            advance: A callback function to indicate progress.
            client: A Syncmatrix client to use for interacting with the Syncmatrix API.
        """
            ...
            try:
                ...
                raise RuntimeError(
                    ...
                    To register the `aws-credentials` block type, run:
                            ...
                            pip install syncmatrix-aws
                            syncmatrix blocks register -m syncmatrix_aws
...
class AuthenticationResource:
    def __init__(
        self,
        work_pool_name: str,
        user_name: str = "syncmatrix-ecs-user",
        policy_name: str = "syncmatrix-ecs-policy",
...
class ClusterResource:
    def __init__(self, cluster_name: str = "syncmatrix-ecs-cluster"):
...
class VpcResource:
    def __init__(
        self,
        vpc_name: str = "syncmatrix-ecs-vpc",
        ecs_security_group_name: str = "syncmatrix-ecs-security-group",
    ):
    ...
    async def _get_syncmatrix_created_vpc(self):
    ...
    async def requires_provisioning(self) -> bool:
        ...
        if await self._get_syncmatrix_created_vpc() is not None:
            self._requires_provisioning = False
            return False
    ...
    async def provision(
        ...
        if await self.requires_provisioning():
            ...
            vpc = await self._get_syncmatrix_created_vpc()
...
class ContainerRepositoryResource:
    def __init__(self, work_pool_name: str, repository_name: str = "syncmatrix-flows"):
    ...
    async def _get_syncmatrix_created_registry(self):
        try:
    ...
    async def requires_provisioning(self) -> bool:
        ...
        if await self._get_syncmatrix_created_registry() is not None:
            self._requires_provisioning = False
            return False
    ...
    async def provision(
        ...
        if await self.requires_provisioning():
            ...
            update_current_profile({SYNCMATRIX_DEFAULT_DOCKER_BUILD_NAMESPACE: namespace})
...
class ExecutionRoleResource:
    def __init__(self, execution_role_name: str = "SyncmatrixEcsTaskExecutionRole"):
        self._iam_client = boto3.client("iam")
...
class ElasticContainerServicePushProvisioner:
    ...
    def _generate_resources(
        ...
        policy_name: str = "syncmatrix-ecs-policy",
        credentials_block_name: str = None,
        cluster_name: str = "syncmatrix-ecs-cluster",
        vpc_name: str = "syncmatrix-ecs-vpc",
        ecs_security_group_name: str = "syncmatrix-ecs-security-group",
        repository_name: str = "syncmatrix-flows",
    ):
        return [
        ...
        try:
            if self.console.is_interactive and Confirm.ask(
                ...
                ecs_security_group_name = prompt(
                    ...
                    default="syncmatrix-ecs-security-group",
                )
