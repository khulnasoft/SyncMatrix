...
class ModalPushProvisioner:
    ...
    def __init__(self, client: Optional[SyncmatrixClient] = None):
        ...
        try:
            ...
            if self._console.is_interactive and not Confirm.ask(
                (
                    ...
                    " token with Syncmatrix Cloud as a block. We'll pull the token from"
