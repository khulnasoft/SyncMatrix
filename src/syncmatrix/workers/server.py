...
import uvicorn
from syncmatrix._vendor.fastapi import APIRouter, FastAPI, status
from syncmatrix._vendor.fastapi.responses import JSONResponse

from syncmatrix.settings import (
    SYNCMATRIX_WORKER_WEBSERVER_HOST,
    SYNCMATRIX_WORKER_WEBSERVER_PORT,
)
...
def start_healthcheck_server(
    ...
    uvicorn.run(
        webserver,
        host=SYNCMATRIX_WORKER_WEBSERVER_HOST.value(),
        port=SYNCMATRIX_WORKER_WEBSERVER_PORT.value(),
        log_level=log_level,
    )
