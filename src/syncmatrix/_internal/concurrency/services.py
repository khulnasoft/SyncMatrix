...
from syncmatrix._internal.concurrency import logger
from syncmatrix._internal.concurrency.api import create_call, from_sync
from syncmatrix._internal.concurrency.cancellation import get_deadline, get_timeout
from syncmatrix._internal.concurrency.event_loop import get_running_loop
from syncmatrix._internal.concurrency.threads import WorkerThread, get_global_loop
...
class QueueService(abc.ABC, Generic[T]):
    ...
    def _stop(self, at_exit: bool = False):
        ...
        with self._lock:
            ...
            # references to all Syncmatrix Task calls made during a flow run, through
