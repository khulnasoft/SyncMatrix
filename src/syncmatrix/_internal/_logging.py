...
class SafeLogger(logging.Logger):
    ...
    def isEnabledFor(self, level: int):
        ...
        from syncmatrix.settings import SYNCMATRIX_LOGGING_INTERNAL_LEVEL

        return level >= logging._nameToLevel[SYNCMATRIX_LOGGING_INTERNAL_LEVEL.value()]
...
logger = logging.getLogger("syncmatrix._internal")
