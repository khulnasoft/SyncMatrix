...
disabled with Syncmatrix settings. Instead, the standard Python warnings filters can be
used.
...
class SyncmatrixDeprecationWarning(DeprecationWarning):
    """
    ...
    *,
    ...
    def decorator(fn: T):
        ...
        def wrapper(*args, **kwargs):
            warnings.warn(message, SyncmatrixDeprecationWarning, stacklevel=stacklevel)
