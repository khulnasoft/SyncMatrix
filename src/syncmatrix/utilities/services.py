...
from syncmatrix.utilities.collections import distinct
...
async def critical_service_loop(
    ...
    while True:
        try:
            ...
            # handler should not be attempting to cover cases where the Syncmatrix server
            # or Syncmatrix Cloud is having an outage (which will be covered by the
            ...
            if exc.response.status_code >= 500:
                # 5XX codes indicate a potential outage of the Syncmatrix API which is
