...
from syncmatrix.utilities.dispatch import get_dispatch_key, lookup_type, register_base_type
...
def add_type_dispatch(model_cls: Type[M]) -> Type[M]:
    ...
    utilities in `syncmatrix.utilities.dispatch` should be used directly.
    """
