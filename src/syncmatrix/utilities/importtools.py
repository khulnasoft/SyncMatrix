...
from syncmatrix.utilities.filesystem import filename, is_local_path, tmpchdir
...
def load_script_as_module(path: str) -> ModuleType:
    ...
    Sets the module name to `__syncmatrix_loader__`.

    If an exception occurs during execution of the script, a
    `syncmatrix.exceptions.ScriptError` is created to wrap the exception and raised.
    ...
    sys.modules["__syncmatrix_loader__"] = module
    ...
    try:
        ...
        sys.modules.pop("__syncmatrix_loader__")
