"""
Core set of steps for specifying a Syncmatrix project pull step.
"""
import os
from pathlib import Path
from typing import Any, Optional

from syncmatrix._internal.compatibility.deprecated import deprecated_callable
from syncmatrix.blocks.core import Block
from syncmatrix.logging.loggers import get_logger
from syncmatrix.runner.storage import BlockStorageAdapter, GitRepository, RemoteStorage
    ...
    Examples:
        ...
        pull:
            - syncmatrix.deployments.steps.git_clone:
                ...
                credentials: "{{ syncmatrix.blocks.github-credentials.my-github-credentials-block }}"
        ```
        ...
        pull:
            - syncmatrix.deployments.steps.git_clone:
                repository: https://github.com/org/repo.git
                access_token: "{{ syncmatrix.blocks.secret.github-access-token }}" # Requires creation of a Secret block
        ```
...
async def pull_from_remote_storage(url: str, **settings: Any):
    ...
    Examples:
        ...
        pull:
            - syncmatrix.deployments.steps.pull_from_remote_storage:
                url: s3://my-bucket/my-folder
                key: {{ syncmatrix.blocks.secret.my-aws-access-key }}}
                secret: {{ syncmatrix.blocks.secret.my-aws-secret-key }}}
        ```
    """
