...
from syncmatrix.serializers import JSONSerializer
...
class SyncmatrixFormatter(logging.Formatter):
    def __init__(
        self,
        format=None,
        datefmt=None,
    ...
    def formatMessage(self, record: logging.LogRecord):
        if record.name == "syncmatrix.flow_runs":
            style = self._flow_run_style
        elif record.name == "syncmatrix.task_runs":
