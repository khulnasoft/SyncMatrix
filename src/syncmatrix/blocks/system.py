...
class JSON(Block):
    ...
    _documentation_url = "https://docs.khulnasoft.com/api-ref/syncmatrix/blocks/system/#syncmatrix.blocks.system.JSON"
...
class String(Block):
    ...
    Example:
        ...
        ```python
        from syncmatrix.blocks.system import String
    ...
    _documentation_url = "https://docs.khulnasoft.com/api-ref/syncmatrix/blocks/system/#syncmatrix.blocks.system.String"
...
class DateTime(Block):
    ...
    Example:
        Load a stored JSON value:
        ```python
        from syncmatrix.blocks.system import DateTime
    ...
    _documentation_url = "https://docs.khulnasoft.com/api-ref/syncmatrix/blocks/system/#syncmatrix.blocks.system.DateTime"
...
class Secret(Block):
    ...
    _documentation_url = "https://docs.khulnasoft.com/api-ref/syncmatrix/blocks/system/#syncmatrix.blocks.system.Secret"
