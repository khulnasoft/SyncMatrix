...
from syncmatrix.settings import (
    SYNCMATRIX_TASK_SCHEDULING_MAX_RETRY_QUEUE_SIZE,
    SYNCMATRIX_TASK_SCHEDULING_MAX_SCHEDULED_QUEUE_SIZE,
)
...
class TaskQueue:
    ...
    default_scheduled_max_size: int = (
        SYNCMATRIX_TASK_SCHEDULING_MAX_SCHEDULED_QUEUE_SIZE.value()
    )
    default_retry_max_size: int = SYNCMATRIX_TASK_SCHEDULING_MAX_RETRY_QUEUE_SIZE.value()
