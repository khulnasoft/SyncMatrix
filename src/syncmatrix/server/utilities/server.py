"""
Utilities for the Syncmatrix REST API server.
"""
...
from syncmatrix._vendor.fastapi import APIRouter, Request, Response, status
from syncmatrix._vendor.fastapi.routing import APIRoute, BaseRoute
from syncmatrix._vendor.starlette.routing import Route as StarletteRoute
...
class SyncmatrixAPIRoute(APIRoute):
    """
...
class SyncmatrixRouter(APIRouter):
    """
    A base class for Syncmatrix REST API routers.
    """

    def __init__(self, **kwargs: Any) -> None:
        kwargs.setdefault("route_class", SyncmatrixAPIRoute)
