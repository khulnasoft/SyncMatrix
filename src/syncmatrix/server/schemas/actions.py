...
from syncmatrix.server.utilities.schemas import get_class_fields_only
...
from syncmatrix.server.utilities.schemas.serializers import orjson_dumps_extra_compatible
from syncmatrix.server.utilities.schemas.transformations import (
    FieldFrom,
    copy_model_fields,
)
from syncmatrix.server.utilities.schemas.validators import (
    raise_on_name_alphanumeric_dashes_only,
    raise_on_name_alphanumeric_underscores_only,
)
from syncmatrix.utilities.templating import find_placeholders
from syncmatrix.utilities.validation import (
    validate_schema,
...
class ActionBaseModel(SyncmatrixBaseModel):
    class Config:
        extra = "forbid"
...
class ConcurrencyLimitV2Create(ActionBaseModel):
    """Data used by the Syncmatrix REST API to create a v2 concurrency limit."""
...
class ConcurrencyLimitV2Update(ActionBaseModel):
    """Data used by the Syncmatrix REST API to update a v2 concurrency limit."""
