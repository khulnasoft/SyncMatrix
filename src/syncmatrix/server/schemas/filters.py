...
from syncmatrix.server.utilities.schemas.bases import SyncmatrixBaseModel
from syncmatrix.server.utilities.schemas.fields import DateTimeTZ
from syncmatrix.utilities.collections import AutoEnum
from syncmatrix.utilities.importtools import lazy_import
...
class SyncmatrixFilterBaseModel(SyncmatrixBaseModel):
    """Base model for Syncmatrix filters"""

    class Config:
        extra = "forbid"

    def as_sql_filter(self, db: "SyncmatrixDBInterface") -> "BooleanClauseList":
    ...
    def _get_filter_list(self, db: "SyncmatrixDBInterface") -> List:
...
class SyncmatrixOperatorFilterBaseModel(SyncmatrixFilterBaseModel):
...
class FlowFilterId(SyncmatrixFilterBaseModel):
    """Filter by `Flow.id`."""
...
class FlowFilterDeployment(SyncmatrixOperatorFilterBaseModel):
...
class FlowFilterName(SyncmatrixFilterBaseModel):
    """Filter by `Flow.name`."""
...
class FlowFilterTags(SyncmatrixOperatorFilterBaseModel):
    """Filter by `Flow.tags`."""
    ...
    def _get_filter_list(self, db: "SyncmatrixDBInterface") -> List:
        from syncmatrix.server.utilities.database import json_has_all_keys
...
class FlowFilter(SyncmatrixOperatorFilterBaseModel):
...
class FlowRunFilterId(SyncmatrixFilterBaseModel):
...
class FlowRunFilterName(SyncmatrixFilterBaseModel):
...
class FlowRunFilterTags(SyncmatrixOperatorFilterBaseModel):
...
class FlowRunFilterDeploymentId(SyncmatrixOperatorFilterBaseModel):
...
class FlowRunFilterWorkQueueName(SyncmatrixOperatorFilterBaseModel):
...
class FlowRunFilterStateType(SyncmatrixFilterBaseModel):
...
class FlowRunFilterStateName(SyncmatrixFilterBaseModel):
...
class FlowRunFilterState(SyncmatrixOperatorFilterBaseModel):
...
class FlowRunFilterFlowVersion(SyncmatrixFilterBaseModel):
...
class FlowRunFilterStartTime(SyncmatrixFilterBaseModel):
...
class FlowRunFilterExpectedStartTime(SyncmatrixFilterBaseModel):
...
class FlowRunFilterNextScheduledStartTime(SyncmatrixFilterBaseModel):
...
class FlowRunFilterParentFlowRunId(SyncmatrixOperatorFilterBaseModel):
...
class FlowRunFilterParentTaskRunId(SyncmatrixOperatorFilterBaseModel):
...
class FlowRunFilterIdempotencyKey(SyncmatrixFilterBaseModel):
...
class FlowRunFilter(SyncmatrixOperatorFilterBaseModel):
...
class TaskRunFilterFlowRunId(SyncmatrixOperatorFilterBaseModel):
...
class TaskRunFilterId(SyncmatrixFilterBaseModel):
...
class TaskRunFilterName(SyncmatrixFilterBaseModel):
...
class TaskRunFilterTags(SyncmatrixOperatorFilterBaseModel):
...
class TaskRunFilterStateType(SyncmatrixFilterBaseModel):
...
class TaskRunFilterStateName(SyncmatrixFilterBaseModel):
...
class TaskRunFilterState(SyncmatrixOperatorFilterBaseModel):
...
class TaskRunFilterSubFlowRuns(SyncmatrixFilterBaseModel):
...
class TaskRunFilterStartTime(SyncmatrixFilterBaseModel):
...
class TaskRunFilter(SyncmatrixOperatorFilterBaseModel):
...
class DeploymentFilterId(SyncmatrixFilterBaseModel):
...
class DeploymentFilterName(SyncmatrixFilterBaseModel):
...
class DeploymentFilterPaused(SyncmatrixFilterBaseModel):
...
class DeploymentFilterWorkQueueName(SyncmatrixFilterBaseModel):
...
class DeploymentFilterIsScheduleActive(SyncmatrixFilterBaseModel):
...
class DeploymentFilterTags(SyncmatrixOperatorFilterBaseModel):
...
class DeploymentFilter(SyncmatrixOperatorFilterBaseModel):
...
class DeploymentScheduleFilterActive(SyncmatrixFilterBaseModel):
...
class DeploymentScheduleFilter(SyncmatrixOperatorFilterBaseModel):
    """Filter for deployments. Only deployments matching all criteria will be returned."""
...
class LogFilterName(SyncmatrixFilterBaseModel):
    """Filter by `Log.name`."""
...
class LogFilterLevel(SyncmatrixFilterBaseModel):
    """Filter by `Log.level`."""
...
class LogFilterTimestamp(SyncmatrixFilterBaseModel):
...
class LogFilterFlowRunId(SyncmatrixFilterBaseModel):
...
class LogFilterTaskRunId(SyncmatrixFilterBaseModel):
...
class LogFilter(SyncmatrixOperatorFilterBaseModel):
...
class BlockTypeFilterName(SyncmatrixFilterBaseModel):
...
class BlockTypeFilterSlug(SyncmatrixFilterBaseModel):
...
class BlockTypeFilter(SyncmatrixFilterBaseModel):
    """Filter BlockTypes"""
...
class BlockSchemaFilterBlockTypeId(SyncmatrixFilterBaseModel):
...
class BlockSchemaFilterId(SyncmatrixFilterBaseModel):
...
class BlockSchemaFilterCapabilities(SyncmatrixFilterBaseModel):
...
class BlockSchemaFilterVersion(SyncmatrixFilterBaseModel):
    """Filter by `BlockSchema.capabilities`"""
...
class BlockSchemaFilter(SyncmatrixOperatorFilterBaseModel):
    """Filter BlockSchemas"""
...
class BlockDocumentFilterIsAnonymous(SyncmatrixFilterBaseModel):
...
class BlockDocumentFilterBlockTypeId(SyncmatrixFilterBaseModel):
...
class BlockDocumentFilterId(SyncmatrixFilterBaseModel):
...
class BlockDocumentFilterName(SyncmatrixFilterBaseModel):
...
class BlockDocumentFilter(SyncmatrixOperatorFilterBaseModel):
...
class FlowRunNotificationPolicyFilterIsActive(SyncmatrixFilterBaseModel):
...
class FlowRunNotificationPolicyFilter(SyncmatrixFilterBaseModel):
...
class WorkQueueFilterId(SyncmatrixFilterBaseModel):
...
class WorkQueueFilterName(SyncmatrixFilterBaseModel):
...
class WorkQueueFilter(SyncmatrixOperatorFilterBaseModel):
...
class WorkPoolFilterId(SyncmatrixFilterBaseModel):
...
class WorkPoolFilterName(SyncmatrixFilterBaseModel):
...
class WorkPoolFilterType(SyncmatrixFilterBaseModel):
...
class WorkPoolFilter(SyncmatrixOperatorFilterBaseModel):
...
class WorkerFilterWorkPoolId(SyncmatrixFilterBaseModel):
...
class WorkerFilterLastHeartbeatTime(SyncmatrixFilterBaseModel):
...
class WorkerFilter(SyncmatrixOperatorFilterBaseModel):
    """Filter by `Worker.last_heartbeat_time`."""
...
class ArtifactFilterId(SyncmatrixFilterBaseModel):
...
class ArtifactFilterKey(SyncmatrixFilterBaseModel):
...
class ArtifactFilterFlowRunId(SyncmatrixFilterBaseModel):
...
class ArtifactFilterTaskRunId(SyncmatrixFilterBaseModel):
...
class ArtifactFilterType(SyncmatrixFilterBaseModel):
...
class ArtifactFilter(SyncmatrixOperatorFilterBaseModel):
...
class ArtifactCollectionFilterLatestId(SyncmatrixFilterBaseModel):
...
class ArtifactCollectionFilterKey(SyncmatrixFilterBaseModel):
...
class ArtifactCollectionFilterFlowRunId(SyncmatrixFilterBaseModel):
...
class ArtifactCollectionFilterTaskRunId(SyncmatrixFilterBaseModel):
...
class ArtifactCollectionFilterType(SyncmatrixFilterBaseModel):
...
class ArtifactCollectionFilter(SyncmatrixOperatorFilterBaseModel):
...
class VariableFilterId(SyncmatrixFilterBaseModel):
...
class VariableFilterName(SyncmatrixFilterBaseModel):
...
class VariableFilterValue(SyncmatrixFilterBaseModel):
...
class VariableFilterTags(SyncmatrixOperatorFilterBaseModel):
...
class VariableFilter(SyncmatrixOperatorFilterBaseModel):
