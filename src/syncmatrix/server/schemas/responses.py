"""
Schemas for special responses from the Syncmatrix REST API.
"""
...
from syncmatrix.server.schemas.core import CreatedBy, FlowRunPolicy, UpdatedBy
from syncmatrix.server.utilities.schemas.bases import ORMBaseModel, SyncmatrixBaseModel
...
if TYPE_CHECKING:
    import syncmatrix.server.database.orm_models
...
class StateAcceptDetails(SyncmatrixBaseModel):
...
class StateRejectDetails(SyncmatrixBaseModel):
...
class StateAbortDetails(SyncmatrixBaseModel):
...
class StateWaitDetails(SyncmatrixBaseModel):
...
class HistoryResponseState(SyncmatrixBaseModel):
...
class HistoryResponse(SyncmatrixBaseModel):
...
class OrchestrationResult(SyncmatrixBaseModel):
    """
...
class WorkerFlowRunResponse(SyncmatrixBaseModel):
    class Config:
...
class FlowRunResponse(ORMBaseModel):
    ...
    @classmethod
    def from_orm(cls, orm_flow_run: "syncmatrix.server.database.orm_models.ORMFlowRun"):
...
class DeploymentResponse(ORMBaseModel):
    ...
    @classmethod
    def from_orm(
        cls, orm_deployment: "syncmatrix.server.database.orm_models.ORMDeployment"
    ):
...
class WorkerResponse(schemas.core.Worker):
    ...
    @classmethod
    def from_orm(
        cls, orm_worker: "syncmatrix.server.database.orm_models.ORMWorker"
    ) -> "WorkerResponse":
