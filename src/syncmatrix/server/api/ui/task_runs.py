...
from syncmatrix._vendor.fastapi import Depends, HTTPException, status
...
def _postgres_bucket_expression(
    db: SyncmatrixDBInterface, delta: pendulum.Duration, start_datetime: datetime
):
