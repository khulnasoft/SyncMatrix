...
import pendulum
from syncmatrix._vendor.fastapi import Body, Depends, HTTPException, Path, Response, status
...
from syncmatrix.server.exceptions import MissingVariableError, ObjectNotFoundError
...
from syncmatrix.utilities.schema_tools.validation import (
    CircularSchemaRefError,
    ValidationError,
    validate,
)

router = SyncmatrixRouter(prefix="/deployments", tags=["Deployments"])
            ...
            if not infrastructure_block:
                raise HTTPException(
                    ...
                    detail=(
                        ...
                        " was built against a different Syncmatrix database / workspace."
                    ),
                )
            ...
            if not infrastructure_block:
                raise HTTPException(
                    ...
                    detail=(
                        ...
                        " against a different Syncmatrix database / workspace."
                    ),
                )
