...
class DataDocument(SyncmatrixBaseModel):
    """
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "id",
            syncmatrix.server.utilities.database.UUID(),
        ...
        sa.Column(
            "created",
            syncmatrix.server.utilities.database.Timestamp(timezone=True),
        ...
        sa.Column(
            "tags",
            syncmatrix.server.utilities.database.JSON(astext_type=Text()),
            server_default="[]",
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "flow_run_id", syncmatrix.server.utilities.database.UUID(), nullable=False
        ),
        sa.Column(
            "task_run_id", syncmatrix.server.utilities.database.UUID(), nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "active_slots",
            syncmatrix.server.utilities.database.JSON(astext_type=sa.Text()),
            server_default="[]",
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "schedule",
            syncmatrix.server.utilities.database.Pydantic(
                syncmatrix.server.schemas.schedules.SCHEDULE_TYPES
            ),
            nullable=True,
        ),
        sa.Column(
        ...
        sa.Column(
            "flow_data",
            syncmatrix.server.utilities.database.Pydantic(DataDocument),
            nullable=True,
        ),
        ...
        sa.Column("flow_id", syncmatrix.server.utilities.database.UUID(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("flow_id", syncmatrix.server.utilities.database.UUID(), nullable=False),
        sa.Column(
            "deployment_id", syncmatrix.server.utilities.database.UUID(), nullable=True
        ),
        sa.Column(
            "parent_task_run_id",
            syncmatrix.server.utilities.database.UUID(),
        ...
        sa.Column("state_id", syncmatrix.server.utilities.database.UUID(), nullable=True),
        sa.ForeignKeyConstraint(
            ["deployment_id"],
            ["deployment.id"],
    ...
    op.create_table(
        ...
        sa.Column(
            "state_details",
            syncmatrix.server.utilities.database.Pydantic(
                syncmatrix.server.schemas.states.StateDetails
            ),
            server_default="{}",
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "empirical_policy",
            syncmatrix.server.utilities.database.Pydantic(
                syncmatrix.server.schemas.core.TaskRunPolicy
            ),
            server_default="{}",
            nullable=False,
        ),
        sa.Column(
            ...
            syncmatrix.server.utilities.database.Pydantic(
                Dict[
                    ...
                    List[
                        Union[
                            syncmatrix.server.schemas.core.TaskRunResult,
                            syncmatrix.server.schemas.core.Parameter,
                            syncmatrix.server.schemas.core.Constant,
                        ]
                    ],
                ]
            ),
    ...
    op.create_table(
        ...
        sa.Column(
            "task_run_id", syncmatrix.server.utilities.database.UUID(), nullable=False
        ),
        sa.ForeignKeyConstraint(
            ["task_run_id"],
            ["task_run.id"],
