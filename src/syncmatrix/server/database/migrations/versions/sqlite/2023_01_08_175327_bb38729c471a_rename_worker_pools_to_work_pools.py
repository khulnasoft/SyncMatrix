...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "base_job_template",
            syncmatrix.server.utilities.database.JSON(),
            nullable=False,
            server_default="{}",
        ),
        ...
        sa.Column(
            "default_queue_id", syncmatrix.server.utilities.database.UUID(), nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "work_pool_id", syncmatrix.server.utilities.database.UUID(), nullable=False
        ),
...
def downgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "worker_pool_id", syncmatrix.server.utilities.database.UUID(), nullable=False
        ),
        sa.ForeignKeyConstraint(
            ["worker_pool_id"],
            ["worker_pool.id"],
