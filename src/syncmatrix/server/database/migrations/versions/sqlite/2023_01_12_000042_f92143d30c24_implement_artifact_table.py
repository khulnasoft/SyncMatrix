...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "task_run_state_id", syncmatrix.server.utilities.database.UUID(), nullable=True
        ),
        sa.Column(
            "flow_run_id", syncmatrix.server.utilities.database.UUID(), nullable=True
        ),
        sa.Column(
            "flow_run_state_id", syncmatrix.server.utilities.database.UUID(), nullable=True
        ),
