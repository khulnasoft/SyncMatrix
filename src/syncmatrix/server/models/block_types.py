...
from syncmatrix.server.database.orm_models import ORMBlockType
...
async def read_block_type_by_slug(
    session: sa.orm.Session, block_type_slug: str, db: SyncmatrixDBInterface
):
    """
...
async def delete_block_type(
    session: sa.orm.Session, block_type_id: str, db: SyncmatrixDBInterface
):
    """
