...
from syncmatrix.server.database.orm_models import ORMBlockDocument
from syncmatrix.server.schemas.actions import BlockDocumentReferenceCreate
from syncmatrix.server.schemas.core import BlockDocument, BlockDocumentReference
from syncmatrix.server.schemas.filters import BlockSchemaFilter
from syncmatrix.server.utilities.database import UUID as UUIDTypeDecorator
from syncmatrix.server.utilities.names import obfuscate_string
from syncmatrix.utilities.collections import dict_to_flatdict, flatdict_to_dict
...
async def block_document_with_unique_values_exists(
    session: AsyncSession, block_type_id: UUID, name: str, db: SyncmatrixDBInterface
) -> bool:
