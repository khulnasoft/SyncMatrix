...
from syncmatrix.server.models.block_types import read_block_type_by_slug
from syncmatrix.server.schemas.actions import BlockSchemaCreate
from syncmatrix.server.schemas.core import BlockSchema, BlockSchemaReference, BlockType
...
async def create_block_schema(
    ...
    """
    from syncmatrix.blocks.core import Block, _get_non_block_reference_definitions
...
def _get_fields_for_child_schema(
    ...
    """
    from syncmatrix.blocks.core import _collect_nested_reference_strings
...
async def delete_block_schema(
    session: sa.orm.Session, block_schema_id: UUID, db: SyncmatrixDBInterface
) -> bool:
    """
...
async def read_available_block_capabilities(
    session: sa.orm.Session, db: SyncmatrixDBInterface
) -> List[str]:
    """
