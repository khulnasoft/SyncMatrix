...
async def _install_protected_system_blocks(session):
    ...
    for block in [
        syncmatrix.blocks.webhook.Webhook,
        syncmatrix.blocks.system.JSON,
        syncmatrix.blocks.system.DateTime,
        syncmatrix.blocks.system.Secret,
        syncmatrix.filesystems.LocalFileSystem,
        syncmatrix.infrastructure.Process,
    ]:
...
async def register_block_schema(
    ...
    """
    Stores the provided block schema in the Syncmatrix REST API database.
    ...
    from syncmatrix.server.models.block_schemas import (
        create_block_schema,
...
async def register_block_type(
    ...
    """
    Stores the provided block type in the Syncmatrix REST API database.
    ...
    """
    from syncmatrix.server.models.block_types import (
        create_block_type,
...
async def run_block_auto_registration(session: sa.orm.Session):
    """
    Registers all blocks in the client block registry and any blocks from Syncmatrix
