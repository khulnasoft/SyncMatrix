...
Syncmatrix implements (most) orchestration with logic that governs a Syncmatrix flow or task
...
While Syncmatrix's [orchestration rules][syncmatrix.server.orchestration.rules.BaseOrchestrationRule]
