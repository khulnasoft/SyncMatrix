...
from syncmatrix.states import Crashed, State
from syncmatrix.task_runners import BaseTaskRunner, TaskConcurrencyType
...
class TaskRunnerStandardTestSuite(ABC):
    ...
    from syncmatrix.testing.standard_test_suites import TaskRunnerStandardTestSuite
    ...
    async def test_is_pickleable_after_start(self, task_runner):
        """
        The task_runner must be picklable as it is attached to `SyncmatrixFuture` objects
        """
