...
from syncmatrix.cli import app
from syncmatrix.utilities.asyncutils import in_async_main_thread
...
def invoke_and_assert(
    ...
    """
    Test utility for the Syncmatrix CLI application, asserts exact match with CLI output.
