# Vendored dependencies of `syncmatrix`
...
gradually bring `pydantic>2` support to `syncmatrix`.  FastAPI's compatibility layer
...
```
./src/syncmatrix/_vendor/vendor-fastapi 0.99.1
```
