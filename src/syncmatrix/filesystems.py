...
from syncmatrix.exceptions import InvalidRepositoryURLError
from syncmatrix.utilities.asyncutils import run_sync_in_worker_thread, sync_compatible
from syncmatrix.utilities.compat import copytree
from syncmatrix.utilities.filesystem import filter_files
...
class LocalFileSystem(WritableFileSystem, WritableDeploymentStorage):
    ...
    _documentation_url = (
        "https://docs.khulnasoft.com/concepts/filesystems/#local-filesystem"
    )
    ...
    async def get_directory(
        ...
        # .syncmatrixignore exists in the original location, not the current location which
        # is most likely temporary
        if (from_path / Path(".syncmatrixignore")).exists():
            ignore_func = await self._get_ignore_func(
                local_path=from_path, ignore_file=from_path / Path(".syncmatrixignore")
            )
        else:
            ignore_func = None
...
class RemoteFileSystem(WritableFileSystem, WritableDeploymentStorage):
    ...
    Example:
        ...
        ```python
        from syncmatrix.filesystems import RemoteFileSystem
    ...
    _documentation_url = (
        "https://docs.khulnasoft.com/concepts/filesystems/#remote-file-system"
    )
...
@deprecated_class(
    start_date="Mar 2024", help="Use the `S3Bucket` block from syncmatrix-aws instead."
)
class S3(WritableFileSystem, WritableDeploymentStorage):
    ...
    It has been replaced by `S3Bucket` from the `syncmatrix-aws` package, which offers enhanced functionality
    ...
    _documentation_url = "https://docs.khulnasoft.com/concepts/filesystems/#s3"
...
@deprecated_class(
    start_date="Mar 2024", help="Use the `GcsBucket` block from syncmatrix-gcp instead."
)
class GCS(WritableFileSystem, WritableDeploymentStorage):
    ...
    This class is deprecated as of March 2024 and will not be available after September 2024.
    It has been replaced by `GcsBucket` from the `syncmatrix-gcp` package, which offers enhanced functionality
    and better a better user experience.
    ...
    Example:
        ...
        ```python
        from syncmatrix.filesystems import GCS
    ...
    _documentation_url = "https://docs.khulnasoft.com/concepts/filesystems/#gcs"
...
@deprecated_class(
    start_date="Mar 2024",
    help="Use the `AzureBlobStorageContainer` block from syncmatrix-azure instead.",
)
class Azure(WritableFileSystem, WritableDeploymentStorage):
    ...
    This class is deprecated as of March 2024 and will not be available after September 2024.
    It has been replaced by `AzureBlobStorageContainer` from the `syncmatrix-azure` package, which
    ...
    Example:
        ...
        ```python
        from syncmatrix.filesystems import Azure
    ...
    _documentation_url = "https://docs.khulnasoft.com/concepts/filesystems/#azure"
...
class SMB(WritableFileSystem, WritableDeploymentStorage):
    ...
    Example:
        ...
        ```python
        from syncmatrix.filesystems import SMB
    ...
    _documentation_url = "https://docs.khulnasoft.com/concepts/filesystems/#smb"
...
@deprecated_class(
    start_date="Mar 2024",
    help="Use the `GitHubRepository` block from syncmatrix-github instead.",
)
class GitHub(ReadableDeploymentStorage):
    """
        ...
        This class is deprecated as of March 2024 and will not be available after September 2024.
        It has been replaced by `GitHubRepository` from the `syncmatrix-github` package, which offers
    ...
    _documentation_url = "https://docs.khulnasoft.com/concepts/filesystems/#github"
    ...
    async def get_directory(
        ...
        with TemporaryDirectory(suffix="syncmatrix") as tmp_dir:
            cmd.append(tmp_dir)
