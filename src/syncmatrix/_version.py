...
def get_keywords():
    ...
    # get_keywords().
    git_refnames = " (tag: 2.16.5)"
    git_full = "6d0ad7459640c83c60599642440374a24262f055"
    git_date = "2024-03-21 15:41:35 -0700"
...
def get_config():
    ...
    cfg.versionfile_source = "src/syncmatrix/_version.py"
    cfg.verbose = False
    return cfg
