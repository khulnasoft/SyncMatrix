...
import syncmatrix.client.schemas.objects as objects
from syncmatrix._internal.compatibility.experimental import experimental_field
from syncmatrix._internal.schemas.bases import ActionBaseModel
from syncmatrix._internal.schemas.fields import DateTimeTZ
from syncmatrix._internal.schemas.serializers import orjson_dumps_extra_compatible
from syncmatrix._internal.schemas.transformations import FieldFrom, copy_model_fields
from syncmatrix._internal.schemas.validators import (
    raise_on_name_alphanumeric_dashes_only,
    raise_on_name_alphanumeric_underscores_only,
)
from syncmatrix.client.schemas.objects import StateDetails, StateType
from syncmatrix.client.schemas.schedules import SCHEDULE_TYPES, NoSchedule
from syncmatrix.utilities.pydantic import get_class_fields_only
...
class StateCreate(ActionBaseModel):
    """Data used by the Syncmatrix REST API to create a new state."""
...
class FlowCreate(ActionBaseModel):
    """Data used by the Syncmatrix REST API to create a flow."""
...
class FlowUpdate(ActionBaseModel):
    """Data used by the Syncmatrix REST API to update a flow."""
...
class DeploymentCreate(ActionBaseModel):
    """Data used by the Syncmatrix REST API to create a deployment."""
...
class DeploymentUpdate(ActionBaseModel):
    """Data used by the Syncmatrix REST API to update a deployment."""
...
class FlowRunUpdate(ActionBaseModel):
    """Data used by the Syncmatrix REST API to update a flow run."""
...
class TaskRunCreate(ActionBaseModel):
    """Data used by the Syncmatrix REST API to create a task run"""
...
class TaskRunUpdate(ActionBaseModel):
    """Data used by the Syncmatrix REST API to update a task run"""
...
class FlowRunCreate(ActionBaseModel):
    """Data used by the Syncmatrix REST API to create a flow run."""
...
class DeploymentFlowRunCreate(ActionBaseModel):
    """Data used by the Syncmatrix REST API to create a flow run from a deployment."""
...
class SavedSearchCreate(ActionBaseModel):
    """Data used by the Syncmatrix REST API to create a saved search."""
...
class ConcurrencyLimitCreate(ActionBaseModel):
    """Data used by the Syncmatrix REST API to create a concurrency limit."""
...
class BlockTypeCreate(ActionBaseModel):
    """Data used by the Syncmatrix REST API to create a block type."""
...
class BlockTypeUpdate(ActionBaseModel):
    """Data used by the Syncmatrix REST API to update a block type."""
...
class BlockSchemaCreate(ActionBaseModel):
    """Data used by the Syncmatrix REST API to create a block schema."""
...
class BlockDocumentCreate(ActionBaseModel):
    """Data used by the Syncmatrix REST API to create a block document."""
...
class BlockDocumentUpdate(ActionBaseModel):
    """Data used by the Syncmatrix REST API to update a block document."""
...
class LogCreate(ActionBaseModel):
    """Data used by the Syncmatrix REST API to create a log."""
...
class WorkPoolCreate(ActionBaseModel):
    """Data used by the Syncmatrix REST API to create a work pool."""

    name: str = FieldFrom(objects.WorkPool)
    description: Optional[str] = FieldFrom(objects.WorkPool)
    type: str = Field(description="The work pool type.", default="syncmatrix-agent")
...
class WorkPoolUpdate(ActionBaseModel):
    """Data used by the Syncmatrix REST API to update a work pool."""
...
class WorkQueueCreate(ActionBaseModel):
    """Data used by the Syncmatrix REST API to create a work queue."""
...
class WorkQueueUpdate(ActionBaseModel):
    """Data used by the Syncmatrix REST API to update a work queue."""
...
class FlowRunNotificationPolicyCreate(ActionBaseModel):
    """Data used by the Syncmatrix REST API to create a flow run notification policy."""
...
class FlowRunNotificationPolicyUpdate(ActionBaseModel):
    """Data used by the Syncmatrix REST API to update a flow run notification policy."""
...
class ArtifactCreate(ActionBaseModel):
    """Data used by the Syncmatrix REST API to create an artifact."""
...
class ArtifactUpdate(ActionBaseModel):
    """Data used by the Syncmatrix REST API to update an artifact."""
...
class VariableCreate(ActionBaseModel):
    """Data used by the Syncmatrix REST API to create a Variable."""
...
class VariableUpdate(ActionBaseModel):
    """Data used by the Syncmatrix REST API to update a Variable."""
...
class GlobalConcurrencyLimitCreate(ActionBaseModel):
    """Data used by the Syncmatrix REST API to create a global concurrency limit."""
...
class GlobalConcurrencyLimitUpdate(ActionBaseModel):
    """Data used by the Syncmatrix REST API to update a global concurrency limit."""
