...
from .clients import AssertingEventsClient, SyncmatrixCloudEventsClient
...
def emit_event(
    ...
    """
    Send an event to Syncmatrix Cloud.
    ...
    operational_clients = [AssertingEventsClient, SyncmatrixCloudEventsClient]
