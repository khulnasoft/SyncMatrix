    ...
    <template v-if="!media.lg">
      <p-global-sidebar class="app__mobile-menu">
        <template #upper-links>
          <p-icon icon="Syncmatrix" class="app__syncmatrix-icon" />
          <span class="text-slate-200">Syncmatrix</span>
        </template>
...
<script lang="ts" setup>
  import { media, PGlobalSidebar, PIcon, useColorTheme } from '@syncmatrix/design'
