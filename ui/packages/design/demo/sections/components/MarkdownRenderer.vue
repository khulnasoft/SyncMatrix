...
`
  ...
  const options: (SelectOptionNormalized & { url: string })[] = [
    { label: 'Syncmatrix', value: 'khulnasoft/syncmatrix', url: 'https://raw.githubusercontent.com/KhulnaSoft/syncmatrix/main/README.md' },
    { label: 'Orion Design', value: 'khulnasoft/syncmatrix', url: 'https://raw.githubusercontent.com/KhulnaSoft/orion-design/main/README.md' },
    { label: 'Vue Compositions', value: 'khulnasoft/syncmatrix', url: 'https://raw.githubusercontent.com/KhulnaSoft/vue-compositions/main/README.md' },
