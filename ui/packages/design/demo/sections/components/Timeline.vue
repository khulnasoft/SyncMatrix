...
<script lang="ts" setup>
  ...
  const items: Item[] = [
    ...
    },
    {
      id: crypto.randomUUID(),
      icon: 'Syncmatrix',
      title: 'Joined Syncmatrix',
      date: '2019-08-01',
      body: 'I joined Syncmatrix as a Software Engineer. I worked on the Syncmatrix Core team, building out the Syncmatrix Cloud and Syncmatrix Server products.',
    },
    {
      id: crypto.randomUUID(),
      title: 'Got a cat',
