...
import { Api, ApiBaseUrl, SyncmatrixConfig } from '@/services/Api'

export type CloudApiConfig = SyncmatrixConfig & {
  accountId: string,
  workspaceId: string,
}

export type WorkspaceApiConfig = SyncmatrixConfig | CloudApiConfig
