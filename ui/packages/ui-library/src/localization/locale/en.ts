export const en = {
  docs: {
    artifacts: 'https://docs.khulnasoft.com/latest/concepts/artifacts/',
    gettingStarted: 'https://docs.khulnasoft.com/latest/getting-started/overview/',
    flows: 'https://docs.khulnasoft.com/latest/concepts/flows/',
    flowRuns: 'https://docs.khulnasoft.com/latest/develop/write-flows#flow-runs',
    blocks: 'https://docs.khulnasoft.com/latest/concepts/blocks/',
    workQueues: 'https://docs.khulnasoft.com/latest/deploy/infrastructure-concepts/work-pools#work-queues',
    notifications: 'https://docs.khulnasoft.com/latest/guides/host/#devex-notifications',
    deployments: 'https://docs.khulnasoft.com/latest/concepts/deployments/',
    concurrency: 'https://docs.khulnasoft.com/latest/develop/write-tasks#concurrency',
    globalConcurrency: 'https://docs.khulnasoft.com/latest/guides/global-concurrency-limits/',
    automations: 'https://docs.khulnasoft.com/latest/automate/events/automations-triggers',
    automationTriggers: 'https://docs.khulnasoft.com/latest/automate/events/automations-triggers#triggers',
    workPools: 'https://docs.khulnasoft.com/latest/concepts/work-pools/',
    collections: 'https://docs.khulnasoft.com/integrations/integrations/',
    resultsPersistence: 'https://docs.khulnasoft.com/latest/develop/results#configuring-result-persistence',
    infrastructure: 'https://docs.khulnasoft.com/latest/concepts/infrastructure/',
    variables: 'https://docs.khulnasoft.com/latest/guides/variables/',
  },
  error: {
  ...
  info: {
    ...
    result: 'Result',
    noResults: 'No tracked results, enable [result persistence](https://docs.khulnasoft.com/concepts/results/#persisting-results) to track results.',
    none: 'None',
    ...
    terminalTaskRunNoArtifacts: 'This task run did not produce any artifacts; for more information on creating artifacts, see the [documentation](https://docs.khulnasoft.com/concepts/artifacts).',
    nonTerminalTaskRunNoArtifacts: 'This task run has not yet produced artifacts; for more information on creating artifacts, see the [documentation](https://docs.khulnasoft.com/concepts/artifacts).',
    terminalFlowRunNoArtifacts: 'This run did not produce any artifacts; for more information on creating artifacts, see the [documentation](https://docs.khulnasoft.com/concepts/artifacts).',
    nonTerminalFlowRunNoArtifacts: 'This run has not yet produced artifacts; for more information on creating artifacts, see the [documentation](https://docs.khulnasoft.com/concepts/artifacts).',
    flowRun: 'Flow run',
    taskRun: 'Task run',
    taskRuns: 'Task runs',
    variable: 'Variable',
    ...
    workPoolInfrastructureConfigurationAgent: 'Syncmatrix Agents handle infrastructure configuration via infrastructure blocks attached to deployments. You can hit **Create** to create this work pool and then head over to the **Blocks** tab to create an infrastructure block for your deployments.\nTo learn more about how to configure infrastructure for Syncmatrix Agents, check out the [docs](https://docs.khulnasoft.com/latest/concepts/infrastructure/).',
