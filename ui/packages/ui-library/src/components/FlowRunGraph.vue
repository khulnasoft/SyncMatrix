...
<script lang="ts" setup>
  import { GraphItemSelection, RunGraphConfig, ViewportDateRange, RunGraphFetchEvents, RunGraphNode, RunGraphStyles, RunGraphStateEvent } from '@syncmatrix/graphs'
  import { useColorTheme } from '@syncmatrix/design'
