...
<script lang="ts" setup>
  /**
   * @deprecated use [SchemaInput](https://github.com/KhulnaSoft/ui-library/tree/main/src/components/SchemaInput.vue) instead
   */
  import { useValidation } from '@syncmatrix/vue-compositions'
