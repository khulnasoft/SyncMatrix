...
<script lang="ts" setup>
  import { SelectOptionGroup, useAttrsStylesClassesAndListeners } from '@syncmatrix/design'
  import { useSubscription, useSubscriptionWithDependencies } from '@syncmatrix/vue-compositions'
