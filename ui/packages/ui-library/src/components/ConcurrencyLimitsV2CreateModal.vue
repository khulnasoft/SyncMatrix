...
<script lang="ts" setup>
  import { PLabel, PNumberInput, PForm, showToast } from '@syncmatrix/design'
  import { useSubscription, useValidation, useValidationObserver } from '@syncmatrix/vue-compositions'
