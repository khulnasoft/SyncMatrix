...
<script lang="ts" setup>
  ...
  import { useValidationObserver } from '@syncmatrix/vue-compositions'
  ...
  const typeIsNotSyncmatrixAgent = computed(() => type.value !== 'syncmatrix-agent')
  const showBaseJobTemplateFormSection = computed(() => type.value && typeIsNotSyncmatrixAgent.value)
