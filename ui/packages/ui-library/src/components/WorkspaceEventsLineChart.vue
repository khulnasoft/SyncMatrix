...
<script lang="ts" setup>
  import { ChartCursor, ChartSelection, LineChart, LineChartData, LineChartDataPoint, useChartCursor, useChartSelection, ChartZoom, ChartZoomOptions } from '@syncmatrix/vue-charts'
  import { useDebouncedRef, useSubscriptionWithDependencies } from '@syncmatrix/vue-compositions'
