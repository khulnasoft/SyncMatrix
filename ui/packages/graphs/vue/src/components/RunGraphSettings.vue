...
<script lang="ts" setup>
  import { CheckboxModel, PButton, positions, PPopOver, SelectModelValue } from '@syncmatrix/syncmatrix-design'
  import { useKeyDown } from '@syncmatrix/vue-compositions'
  import { ref } from 'vue'
  import {
