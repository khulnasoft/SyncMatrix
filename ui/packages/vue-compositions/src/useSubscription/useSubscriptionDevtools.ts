...
const SUBSCRIPTIONS_INSPECTOR_ID = 'syncmatrix-vue-compositions-subscriptions'
const SUBSCRIPTIONS_TIMELINE_LAYER_ID = 'syncmatrix-vue-compositions-subscriptions'
...
export const SUBSCRIPTION_DEVTOOLS_SETTINGS = {
  ...
  //     { value: 0x175cd3, label: 'Syncmatrix Blue' },
