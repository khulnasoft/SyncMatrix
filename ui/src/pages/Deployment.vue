...
<script lang="ts" setup>
  ...
  import { SyncmatrixStateNames, DeploymentDescription, FlowRunListItem, DeploymentDetails, DeploymentDescriptionEmptyState, PageHeadingDeployment, ParametersTable, DeploymentDeprecatedMessage, useTabs, useWorkspaceApi, useFlowRunsFilter, syncmatrixStateNames, DeploymentConfiguration, useNextFlowRun, FlowRunFilteredList } from '@syncmatrix/ui-library'
  ...
  const { filter: flowRunsFilter } = useFlowRunsFilter({
    ...
    flowRuns: {
      state: {
        name: syncmatrixStateNames.filter(stateName => stateName !== 'Scheduled'),
      },
    },
  })
