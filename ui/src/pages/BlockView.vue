...
<script lang="ts" setup>
  import { PageHeadingBlock, BlockDocumentCard, useWorkspaceApi } from '@syncmatrix/ui-library'
  import { useSubscriptionWithDependencies, useRouteParam } from '@syncmatrix/vue-compositions'
