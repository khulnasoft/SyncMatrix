...
<script lang="ts" setup>
  import { PageHeadingBlocksCatalogView, BlockTypeCard, useWorkspaceApi } from '@syncmatrix/ui-library'
  import { useRouteParam, useSubscriptionWithDependencies } from '@syncmatrix/vue-compositions'
