<template>
  <p-layout-default class="workspace-dashboard">
    ...
    <MarketingBanner
      ...
      subtitle="Automations, role and object-level security, and serverless push work pools on Syncmatrix Cloud"
    >
      <template #actions>
        <p-button to="https://www.khulnasoft.com/cloud-vs-oss?utm_source=oss&utm_medium=oss&utm_campaign=oss&utm_term=none&utm_content=none" target="_blank" primary>
          Upgrade to Cloud
        </p-button>
      </template>
    </MarketingBanner>
...
<script setup lang="ts">
  import { Crumb } from '@syncmatrix/design'
  import {
